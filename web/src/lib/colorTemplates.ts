...
const staticDefinitions: ColorTokenDefinition[] = [
  ...
  { id: "numbers.candidateText", label: "Possible Draw candidate text", group: "numbers", defaultValue: "#6B4B00" },
  { id: "numbers.fixed", label: "Possible Draw fixed", group: "numbers", defaultValue: "#2E63C5" },
  { id: "numbers.fixedBorder", label: "Possible Draw fixed border", group: "numbers", defaultValue: "#10283F" },
  { id: "numbers.fixedText", label: "Possible Draw fixed text", group: "numbers", defaultValue: "#FFFFFF" },
  { id: "numbers.excluded", label: "Possible Draw excluded", group: "numbers", defaultValue: "#E8ECEF" },
  { id: "numbers.excludedText", label: "Possible Draw excluded text", group: "numbers", defaultValue: "#718197" },
