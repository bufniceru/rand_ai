# MKGSV v1 promotion report

Preserved from the original hierarchical implementation on
`data/lotto_results_2019.yaml`. The 770 evaluated predictions are split into
320 warm-up draws, 200 development-validation draws, and an untouched
latest-250 holdout.
...
in `reports/mkgsv_v1_benchmark.json`.
